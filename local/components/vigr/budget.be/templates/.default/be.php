...
<div class="be-item new" data-id = <?=$beId?>>
    ...
    <div class="de-inline-bl de-sum" style="display: none">
        ...
        <div class="ui-ctl ui-ctl-textbox ui-ctl-sm ui-ctl-block">
            <input type="hidden" value="<?=$arResult['AR_BUDGETS'][$arItem['id']]?>" disabled type="text" class="budgetInput ui-ctl-element" placeholder="сумма">
        </div>
    </div>
    ...
    <div class="de-inline-bl">
        <button <?=$disabledDelete?> class="delete ui-btn ui-btn-light-border ui-ctl-block ui-btn-sm">X</button>
    </div>

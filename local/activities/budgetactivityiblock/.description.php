...
$arActivityDescription = array(
    ...
    'NAME' => '[Immo] Бюджет - действие с заявкой',

    // Описание действия для конструктора.
    'DESCRIPTION' => 'Действие бюджетом финансовой заявки инфоблока. Оплата, частичная оплата, отмена оплаты',

    // Тип: “activity” - действие, “condition” - ветка составного действия.
    'TYPE' => 'activity',

    // Название класса действия без префикса “CBP”.
    'CLASS' => 'BudgetActivityIblock',
